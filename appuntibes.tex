...
\mainmatter
\input{introduzione}
\input{ConsiglioDiClasse}
\input{CosaFalaScuola}
\backmatter
%\nocite{*}
%\cleardoublepage
%\phantomsection
\appendixpage
\include{direttiva27dic2012}
\include{cm8_2013}
\include{ra_140_2012}
\include{Modello_Piano_Annuale_Inclusione}
\include{dpcm23_febbraio_2006}
\include{tar_liguria_sentenza1178_2012}
\include{tar_Umbria_sentenza_329_2011}
\include{tar_Toscana_sentenza_346_2013}

\include{legge53_2003}
\include{lineeGuidaStudentiStranieri}
%include{Legge289_02}

\include{schema_bes}
\include{QuadSinBES}
\include{regolamentoGLI}
\include{BES2PUBB}
%\chapter{Riferimenti}
%\chapter{Riferimenti}
